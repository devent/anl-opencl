...
REAL value_noise3D(REAL x, REAL y, REAL z, uint seed, interp_func interp);
REAL value_noise4D(REAL x, REAL y, REAL z, REAL w, uint seed, interp_func interp);
REAL value_noise6D(REAL x, REAL y, REAL z, REAL w, REAL u, REAL v, uint seed, interp_func interp);
